...
plt.xlim(.075,0.525)
plt.plot([0,0.6], [0,0], 'k--')
plt.title(r'Additive bias (1st component): with galaxy SEDs at galaxy positions. Errorbars in position.')
if save_plot:
    plt.savefig(plot_path+'{}.eps'.format(ID),format='eps',dpi=1200)
    plt.savefig(plot_path+'{}.jpg'.format(ID),format='jpeg',dpi=1200)
    ID +=1
...
plt.xlim(.075,0.525)
plt.plot([0,0.6], [0,0], 'k--')
plt.title('Multiplicative bias: with galaxy SEDs at star galaxy. ')# Every position has one single SED. Errorbar position.
if save_plot:
    plt.savefig(plot_path+'{}.eps'.format(ID),format='eps',dpi=1200)
    plt.savefig(plot_path+'{}.jpg'.format(ID),format='jpeg',dpi=1200)
    ID +=1
...
plt.xlim(.075,0.525)
plt.plot([0,0.6], [0,0], 'k--')
plt.title('Additive bias: with galaxy SEDs at galaxy positions. ')# Every position has one single SED. Errorbar position.
if save_plot:
    plt.savefig(plot_path+'{}.eps'.format(ID),format='eps',dpi=1200)
    plt.savefig(plot_path+'{}.jpg'.format(ID),format='jpeg',dpi=1200)
    ID +=1
